...
ContributorView.Prototype = function() {
  ...
  this.render = function() {
    ...
    children: [$$('img', {src: "data/MagiciansOfMoz/ChristianFrisson.jpg"})]
     }));
    //}
    ...
    if (this.node.contribution) {
      this.content.appendChild($$('.label', {text: 'More information'}));
      this.content.appendChild($$('a', {href: this.node.contribution, text: this.node.contribution, target: "_blank"}));
    }
...
FigureView.Prototype = function() {
  ...
  this.render = function() {
    ...
    /* Christian: make the image toggle fullscreen mode */
    /*var imgToggle = $$("a.toggle-fullscreen", {
      href: "#",
      "sbs-click": "toggleFullscreen("+this.node.id+")"
    });*/
    ...
    var imgEl = $$('.image-wrapper', {
      children: [
        $$("a", {
          /*
           * Christian: remove direct image link for better browsability
          href: this.node.url,
          target: "_blank",
          */
        /* Christian: make the image toggle fullscreen mode */    
    ...
    /* Christian: make the image toggle fullscreen mode */
    /*imgToggle.appendChild(imgEl);
    this.content.appendChild(imgToggle);*/
    ...
    var dateRows = [
      $$('tr', {
        children: [
          ...
          $$('td', {
            children: [
              $$('div.label', {text: "Published online"}),
...
ElifeConfiguration.Prototype = function() {
  ...
  this.extractPublicationInfo = function(converter, state, article) {
    ...
    */
    ...
    //Christian doc.show("info", pubInfoNode.id, 0);
  };
  ...
  this.enhanceInfo = function(converter, state, article) {
    ...
    /* Christian doc.show("info", articleInfo.id);*/
  };
...
var CoverLetterConfiguration = require("./configurations/default");
...
LensImporter.Prototype = function() {
  ...
  this.document = function(state, xmlDoc) {
    ...
    } else if (publisherName === "eLife Sciences Publications, Ltd" || publisherName === "" ) {
      state.config = new ElifeConfiguration();
    } else if (publisherName === "Cover Letter") {
      state.config = new CoverLetterConfiguration();
  ...
  this.citation = function(state, ref, citation) {
    ...
    if (personGroup) {
      ...
      var url = citation.querySelector("pub-id[pub-id-type='url'], ext-link[ext-link-type='url']");
      if(url) citationNode.url = url.textContent;        
